...
{
    public class ChiTietBoCauHoiRepository : Repository<ChiTietBoCauHoi>, IChiTietBoCauHoiRepository
    {
        public ChiTietBoCauHoiRepository(ElearningDbContext context) : base(context)
        {
        }
