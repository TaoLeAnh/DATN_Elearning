...
using Elearning.Shared.Commons.Querys.SQL;
...
#pragma warning disable CS8604 // Possible null reference argument.
        ...
        */
        public IQueryable<T> FilterData(Func<IQueryable<T>, IQueryable<T>> filterFunc, GridRequest gridRequest, ref int TotalRecords)
        {
            ...
            query = QueryExtensions.GetByGridRequest<T, DefaultClass, DefaultClass, DefaultClass, DefaultClass>(query, gridRequest, ref TotalRecords);
        ...
        {
            var query = _context.Set<T>().AsQueryable();
            query = QueryExtensions.GetByGridRequest<T, O, DefaultClass, DefaultClass, DefaultClass>(query, gridRequest, ref totalRecords);
            return query;
        }
        ...
        {
            var query = _context.Set<T>().AsQueryable();
            query = QueryExtensions.GetByGridRequest<T, U, V, DefaultClass, DefaultClass>(query, gridRequest, ref totalRecords);
            return query;
        }
        ...
        {
            var query = _context.Set<T>().AsQueryable();
            query = QueryExtensions.GetByGridRequest<T, U, V, W, DefaultClass>(query, gridRequest, ref totalRecords);
            return query;
        }
        #endregion
