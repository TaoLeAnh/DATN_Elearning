...
namespace Elearning.Publising.Infrastructure.Repositories
{
    public class ChuongHocRepository : Repository<ChuongHoc>, IChuongHocRepository
    {
        ...
        public ChuongHocRepository(AppDbContext context) : base(context)
        {
            _context = context;
        }

        public Task<(List<ChuongHocDto> Items, int Total)> GetPagedDtoAsync(ChuongHocQuery searchOption)
        {
